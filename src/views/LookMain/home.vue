<template>
    <div class="home">
        <div class="top-section" ref="topSectionRef" :class="{ 'top-section-phone': domWidth <= 700 }">
            <div class="head-img" :style="{ height: domWidth <= 700?'calc(50% - 2em)':'calc(100% - 2em)' }">
                <div class="title">
                    <span>头部图片</span>
            ...
            <div class="carousel-img" :style="{ height: domWidth <= 700?'calc(50% - 2em)':'calc(100% - 2em)' }">
                <div class="title">
                    <span>轮播图</span>
                ...
                <el-scrollbar class="scroll-img" :height="'calc(100% - 3em)'">
                    <div class="img-box">
                        <el-carousel v-if="reloadFlag" trigger="click" height="150px" style="width: 400px;"
                            :autoplay="false">
                    ...
                    <DndProvider :backend="HTML5Backend">
                        <div class="show-img">
                            ...
                            <div class="img-list-box">
                                <DraggableImage @contextmenu.prevent="delCarouselHandle(item)"
                                    @click="changeCarouselImageHandle(item)" @change="changeCarouselHandle"
                                    v-for="(item, index) in carouseImgShow" :key="index" :item="item" />
                                <DropEmptyImage @click="changeCarouselImageHandle(undefined, 1)"
                                    v-if="carouseImgShow.length < 5" @change="dragIntoEmptyHandle" :type="1">
                                </DropEmptyImage>
                            </div>
                        </div>
                        <div class="img-list">
                            ...
                            <div class="img-list-box">
                                <DraggableImage @contextmenu.prevent="delCarouselHandle(item)"
                                    @click="changeCarouselImageHandle(item)" @change="changeCarouselHandle"
                                    v-for="(item, index) in carouselImgHide" :key="index" :item="item" />
                                <DropEmptyImage @click="changeCarouselImageHandle(undefined, 0)"
                                    @change="dragIntoEmptyHandle" :type="0"></DropEmptyImage>
                            </div>
                        </div>
                    </DndProvider>
                </el-scrollbar>
...
import { computed, nextTick, onMounted, Ref, ref, toRaw, toRef, watch } from 'vue'
